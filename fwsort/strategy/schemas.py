...
class AutoStrategyUpdate(BaseModel):
    """更新任务请求"""
...
class AutoStrategyResponse(BaseModel):
    """任务响应"""
...
class AutoStrategyLogResponse(BaseModel):
    """任务日志响应"""
...
class AutoStrategyStartResponse(BaseModel):
    """任务启动响应"""

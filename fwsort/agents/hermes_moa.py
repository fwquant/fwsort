...
def build_hermes_moa() -> HermesMoA:
    from fwsort.agents.claude_agent import ClaudeAgent
    from fwsort.agents.gemini_agent import GeminiAgent
    from fwsort.agents.openai_agent import OpenAIAgent
